...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('templateweb')}}templateweb/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="{{ asset('templateweb')}}templateweb/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="{{ asset('templateweb')}}templateweb/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="{{ asset('templateweb')}}templateweb/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
  <link href="{{ asset('templateweb')}}templateweb/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="{{ asset('templateweb')}}templateweb/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="{{ asset('templateweb')}}templateweb/assets/css/main.css" rel="stylesheet">
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <img src="assets/images/hero-carousel/ptlogo.png" alt="">
        <h1 class="sitename">PT.SMELTING</h1> <span>.</span>
      </a>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Work Permit</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="#">Cold Work Permit</a></li>
              <li><a href="#">Work at High Permit</a></li>
              <li><a href="#">Welding Permit</a></li>
            </ul>
          </li>
            @if (Route::has('login'))
                @auth
    ...
    <section id="hero" class="hero section dark-background">
        ...
        <div class="container">
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-6 text-center">
              <h2>Work Permit</h2>
              <p>Mari taati aturan dan perhatikan keselamatan selama bekerja, ajukan izin untuk bekerja demi keselamatan bersama, ya!</p>
              <a href="/login" class="btn-get-started">Ajukan Work Permit</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item">
          <img src="assets/images/hero-carousel/hot.jpg" alt="">
        </div>

        <div class="carousel-item active">
          <img src="assets/images/hero-carousel/pres.jpg" alt="">
        </div>

        <div class="carousel-item">
          <img src="assets/images/pln.jpg" alt="">
        </div>
        ...
        <div class="row justify-content-between gy-10">
          <div class="col-lg-5 align-items-start" data-aos="zoom-out" data-aos-delay="600">
            <div class="content">
              ...
              <h2>VISI</h2>
              <p style="text-align: justify;">Berkontribusi pada pembangunan berkelanjutan terhadap Masyarakat Setempat, Republik Indonesia dan Dunia melalui bisnis peleburan dan pemurnian tembaga kami.</p>
              <h2>MISI</h2>
              ...
              <div class="row">
                ...
                <div class="col-xl-7 d-flex align-items-center">
                  <div class="card-body">
                    ...
                    <p style="display: list-item; list-style-type: disc; margin-left: 20px; margin-bottom: 5px;">Nama Dagang       : Gresik Copper Cathode</p>
                    <p style="display: list-item; list-style-type: disc; margin-left: 20px; margin-bottom: 5px;">Kategori          : LME Kelas A</p>  
                    <p style="display: list-item; list-style-type: disc; margin-left: 20px; margin-bottom: 5px;">Berat             : 50 kg & 100 kg</p>  
                    <p style="display: list-item; list-style-type: disc; margin-left: 20px; margin-bottom: 5px;">Desain Kapasitas  : 200,000 T/Y</p>  
                    <p style="display: list-item; list-style-type: disc; margin-left: 20px; margin-bottom: 5px;">Kapasitas Sekarang: 300,000 T/Y</p>  
                    <p style="display: list-item; list-style-type: disc; margin-left: 20px; margin-bottom: 5px;">Digunakan untuk   : Kawat, Kabel, Tube, dll</p>  
    ...
    <section id="alt-services" class="alt-services section">
      ...
      <div class="container">
        ...
        <div class="row justify-content-around gy-4">
          <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100"><img src="assets/images/maps.png" alt=""></div>
      ...
      <div class="container">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
            ...
            <li data-filter=".filter-remodeling">Produk Utama</li>
            <li data-filter=".filter-construction">Produk Sampingan</li>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-remodeling">
              <div class="portfolio-content h-100">
                <img src="assets/images/katoda.png" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Katoda Tembaga</h4>
                  <a href="http://www.ptsmelting.com/i-produk-msds-katoda.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-construction">
              <div class="portfolio-content h-100">
                <img src="assets/images/asam.png" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Asam Sulfat</h4>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-construction">
              <div class="portfolio-content h-100">
                <img src="assets/images/anoda.jpeg" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Lumpur Anoda</h4>
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
  ...
  <footer id="footer" class="footer dark-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Awak Rantau</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/php-email-form/validate.js"></script>
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/aos/aos.js"></script>
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="{{ asset('templateweb')}}templateweb/assets/vendor/purecounter/purecounter_vanilla.js"></script>
