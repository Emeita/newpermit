...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('templateweb/about.html') }}/assets/images/hero-carousel/ptlogo.png" rel="icon">
  ...
  <link href="{{ asset('templateweb') }}/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
